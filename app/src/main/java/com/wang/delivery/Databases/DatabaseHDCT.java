package com.wang.delivery.Databases;
...
public class DatabaseHDCT {
    ...
    public void insert(HDCT item){
        ...
        HDCT hdctTest = new HDCT(key, key, item.getThoigian(), item.getCheck(), item.getIdUser(),item.getPayment(), item.getIdShipper(), item.getOrderArrayList());
